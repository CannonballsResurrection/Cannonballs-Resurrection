...
#
# Kenneth's own work (his website + the all-islands patch in ../patch/island.exe) IS in this repo.
#
...
echo "and island.zip (his Access-all-Islands patch — also kept in ../patch/island.exe)."
echo
