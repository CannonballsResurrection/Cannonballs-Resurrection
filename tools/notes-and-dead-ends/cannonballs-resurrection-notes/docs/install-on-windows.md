...
- The **game installer**, the **Microsoft Java VM**, and Kenneth's **`island.exe`** patch.
  - The patch is in this repo, in Kenneth's archive:
    [`island.exe`](../../../../resurrection-archive/patch/island.exe).
...
You already have the patch (`resurrection-archive/patch/island.exe` in this repo) — copy that over too.
...
- Run **`island.exe`** (from `resurrection-archive/patch/`). This is the **"Access all Islands"** patch: it removes the
...
[kenneth-2016-followup.md](../../../../resurrection-archive/docs/kenneth-2016-followup.md). Please be kind — this is a one-person passion
